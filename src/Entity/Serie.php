...
class Serie
{
     ...
     *     min=2,
     *     max=255,
     *     minMessage="Minimum 2 charaters please !",
     *     minMessage="Maximum 255 charaters please !"
     * )
     *
     ...
     *     max=3000,
     *     minMessage="Minimum 2 charaters please !",
     *     minMessage="Maximum 3000 charaters please !"
     * )
     *
     ...
     *     message="Last Air Date must be greather than First Air Date !")
     *
     * @ORM\Column(type="date")
     */
    private $lastAirDate;
